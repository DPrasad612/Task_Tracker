...
export default function SignupPage() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center min-h-screen p-6 relative select-none">
      {/* Decorative Blob */}
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-pastel-blue dark:bg-pastel-blue/10 rounded-full blur-3xl opacity-40 -z-10"></div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="px-4 py-3 bg-bg-muted border border-border-base rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-btn-primary transition-all duration-150"
              />
            </div>
